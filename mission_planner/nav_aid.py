...
def turn_command(channel,drone_address=0xff):   
    ...
    for i in range(2):
        ...
        #change 0x00 above to whichever number yan yew specifies for turning
        #need 3 numbers for turn left, turn right and u turn
        print('send turn to ' + str(drone_address))
...
if __name__ == '__main__':
    try:
            turn_command(channel=int(sys.argv[1]), drone_address=int(sys.argv[2], 16))
    except IndexError:
