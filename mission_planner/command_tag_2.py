...
def command_tag_2(channel,drone_address=0xff):   
    id = 2
    done = False
    ...
    while (not done):
        try:
            ...
            print(f"command_tag_2: Error with dongle {id}")
            id = (id + 1) % 7
...
if __name__ == '__main__':
    try:
            ...
            command_tag_2(channel=int(sys.argv[1]), drone_address=(int(sys.argv[2],16)))
